...
<header class="app-header flex items-center px-4 gap-3">
    ...
    <a href="{{ route('any', 'index') }}" class="logo-box">
        ...
        <div class="logo-light">
            <img src="/public/images/" class="logo-lg h-6" alt="Light logo">
    ...
    <div class="relative">
        <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
            <img src="https://www.transparentpng.com/download/user/gray-user-profile-icon-png-fP8Q1P.png" alt="user-image" class="img-profile rounded-full h-10">
        </button>
